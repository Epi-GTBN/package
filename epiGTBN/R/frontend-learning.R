...
# GTBN-2nodes frontend.
gtbn2 = function(x, start = NULL, whitelist = NULL, blacklist = NULL,
  ...
  greedy.search(x = x, start = start, whitelist = whitelist,
    blacklist = blacklist, score = score, heuristic = "gtbn2", debug = debug,
    expand = c(list(...), restart = restart, perturb = perturb,
    max.iter = max.iter, maxp = maxp), optimized = optimized)

}#GTBN2

# GTBN-3nodes frontend.
gtbn3 = function(x, start = NULL, whitelist = NULL, blacklist = NULL,
    score = NULL, ..., debug = FALSE, restart = 0, perturb = 1,
    max.iter = Inf, maxp = Inf, optimized = TRUE) {

  greedy.search(x = x, start = start, whitelist = whitelist,
    blacklist = blacklist, score = score, heuristic = "gtbn3", debug = debug,
    expand = c(list(...), restart = restart, perturb = perturb,
    max.iter = max.iter, maxp = maxp), optimized = optimized)

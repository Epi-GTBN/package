...
score.based.algorithms = c("gtbn2", "gtbn3", "tabu")
...
available.learning.algorithms = c(constraint.based.algorithms, score.based.algorithms,
  mim.based.algorithms, classifiers)

# always.dag.result = c(score.based.algorithms, hybrid.algorithms, classifiers)
always.dag.result = c(score.based.algorithms, classifiers)
...
method.labels = c(
  ...
  'gtbn2' = "GTBN for 2 nodes",
  'gtbn3' = "GTBN for 3 nodes",
  'tabu' = "Tabu Search",
...
method.extra.args = list(
  'gtbn2' = c("max.iter", "maxp", "restart", "perturb"),
  'gtbn3' = c("max.iter", "maxp", "restart", "perturb"),
